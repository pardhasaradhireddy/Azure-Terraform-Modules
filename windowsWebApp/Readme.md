...
| <a name="input_enable_management_lock"></a> [enable\_management\_lock](#input\_enable\_management\_lock) | (Optional) Should the Windows Web App Management Lock be enabled? Defaults to false | `bool` | `false` | no |
| <a name="input_enabled"></a> [enabled](#input\_enabled) | (Optional) Should the Windows Web App be enabled? Defaults to true | `bool` | `true` | no |
...
| <a name="input_https_only"></a> [https\_only](#input\_https\_only) | (Optional) Should the Windows Web App require HTTPS connections. Defaults to false. | `bool` | `false` | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | (Optional) A mapping of tags which should be assigned to the Windows Web App. | `map(any)` | `{}` | no |
...
| <a name="input_zip_deploy_file"></a> [zip\_deploy\_file](#input\_zip\_deploy\_file) | (Optional) The local path and filename of the Zip packaged application to deploy to this Windows Web App. | `any` | `null` | no |
