...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_rbac"></a> [rbac](#module\_rbac) | ../roleAssignment | n/a |
...
| <a name="input_roleAssignment"></a> [roleAssignment](#input\_roleAssignment) | (Optional) Role Assignment for Resource Group | `any` | `[]` | no |
